...
class NodeBuilder implements NodeBuilderInterface
{
    ...
    {
        if (!isset($ast['kind'])) {
            throw new LanguageException(sprintf('Nodes must specify a kind, got %s',
                json_encode($ast)));
        }
        ...
        throw new LanguageException(sprintf('Node of kind "%s" not supported.',
            $kind));
    }
     ...
     * @throws LanguageException
     */
    protected function buildDirectiveDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildEnumTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildEnumValueDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildFragmentDefinition(array $ast
    ): FragmentDefinitionNode {
        return new FragmentDefinitionNode([
            'name' => $this->buildNode($ast, 'name'),
            'variableDefinitions' => $this->buildNodes($ast,
                'variableDefinitions'),
     ...
     * @throws LanguageException
     */
    protected function buildInputObjectTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildInputObjectTypeExtension(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildInputValueDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildInterfaceTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildInterfaceTypeExtension(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildObjectTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildObjectTypeExtension(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildOperationDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildOperationTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildScalarTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildScalarTypeExtension(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildUnionTypeDefinition(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildUnionTypeExtension(array $ast
     ...
     * @throws LanguageException
     */
    protected function buildVariableDefinition(array $ast
