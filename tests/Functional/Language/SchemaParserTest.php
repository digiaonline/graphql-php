                ...
                [
                    ...
                    'fields' => [
                        $this->fieldNode(
                            $this->nameNode('world',
                                ['start' => 16, 'end' => 21]),
                            $this->typeNode(TypeNameEnum::STRING,
                                ['start' => 23, 'end' => 29]),
                            ['start' => 16, 'end' => 29]
                        ),
                    ],
                    ...
                    'fields' => [
                        $this->fieldNode(
                            ...
                            [
                                ...
                                'type' => $this->typeNode(TypeNameEnum::STRING,
                                    ['start' => 23, 'end' => 29]),
                                'loc' => ['start' => 23, 'end' => 30],
                            ],
                            ['start' => 16, 'end' => 30]
        ...
        $this->assertEquals(jsonEncode([
            ...
            'definitions' => [
                [
                    ...
                    'directives' => [],
                    'values' => [
                        $this->enumValueNode('WO',
                            ['start' => 13, 'end' => 15]),
                        $this->enumValueNode('RLD',
                            ['start' => 17, 'end' => 20]),
                    ],
                    'loc' => ['start' => 0, 'end' => 22],
                ],
                        ...
                        $this->fieldNodeWithArguments(
                            ...
                            [
                                $this->inputValueNode(
                                    $this->nameNode('flag',
                                        ['start' => 22, 'end' => 26]),
                                    $this->typeNode(TypeNameEnum::BOOLEAN,
                                        ['start' => 28, 'end' => 35]),
                                    null,
                                    ['start' => 22, 'end' => 35]
                                ),
                    ...
                    'fields' => [
                        $this->fieldNodeWithArguments(
                            ...
                            [
                                ...
                                $this->inputValueNode(
                                    $this->nameNode('argTwo',
                                        ['start' => 39, 'end' => 45]),
                                    $this->typeNode(TypeNameEnum::INT,
                                        ['start' => 47, 'end' => 50]),
                                    null,
                                    ['start' => 39, 'end' => 50]
                                ),
